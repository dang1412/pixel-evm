    ...
    <div className="absolute bottom-2 left-1/2 w-[98%] -translate-x-1/2 rounded-lg border border-gray-700/30 bg-gray-900/40 p-2 text-white shadow-lg sm:bottom-4 sm:w-[95%] sm:rounded-xl sm:border-gray-700/50 sm:bg-gradient-to-b sm:from-gray-900/70 sm:to-gray-950/75 sm:p-3 sm:shadow-2xl sm:backdrop-blur-md md:w-auto md:min-w-[650px] md:border-gray-700/20 md:bg-gray-900/20 md:p-2 md:backdrop-blur-none lg:min-w-[750px]">
      <div className="flex items-center gap-1.5 sm:gap-3">
        ...
        <div className="flex shrink-0 items-center gap-1 sm:gap-2">
          ...
          <div className="flex min-w-[60px] flex-col items-center justify-center rounded-md bg-gray-800/40 px-1.5 py-1 sm:min-w-[85px] sm:rounded-lg sm:bg-gray-800/50 sm:px-3 sm:py-2 md:min-w-[100px]">
            ...
            <span className="text-xs font-bold sm:text-base md:text-lg">
              {round}<span className="text-gray-500">/{maxRound}</span>
            </span>
          </div>
          <button
        ...
        <button
          ...
          className="group relative shrink-0 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 p-2.5 shadow-md transition-all hover:scale-105 hover:from-blue-400 hover:to-blue-500 hover:shadow-xl active:scale-95 sm:p-3.5 sm:shadow-lg md:p-4"
        ...
        <div className="flex min-w-0 flex-1 items-center gap-1.5 sm:gap-2">
          ...
          <div className="relative h-1.5 min-w-0 flex-1 sm:h-2.5 md:h-3">
            ...
            <input
              ...
              className="absolute h-full w-full cursor-pointer appearance-none bg-transparent [&::-moz-range-thumb]:h-3.5 [&::-moz-range-thumb]:w-3.5 [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-white [&::-moz-range-thumb]:bg-blue-500 [&::-moz-range-thumb]:shadow-lg [&::-moz-range-thumb]:transition-transform [&::-moz-range-thumb]:hover:scale-125 [&::-webkit-slider-thumb]:h-3.5 [&::-webkit-slider-thumb]:w-3.5 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-webkit-slider-thumb]:bg-blue-500 [&::-webkit-slider-thumb]:shadow-lg [&::-webkit-slider-thumb]:transition-transform [&::-webkit-slider-thumb]:hover:scale-125 sm:[&::-moz-range-thumb]:h-5 sm:[&::-moz-range-thumb]:w-5 sm:[&::-webkit-slider-thumb]:h-5 sm:[&::-webkit-slider-thumb]:w-5 md:[&::-moz-range-thumb]:h-6 md:[&::-moz-range-thumb]:w-6 md:[&::-webkit-slider-thumb]:h-6 md:[&::-webkit-slider-thumb]:w-6"
