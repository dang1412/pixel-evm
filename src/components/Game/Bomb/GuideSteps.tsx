export const GuideSteps = [
  ...
  },
  {
    content: (
      <div>
        ...
        <p className="mt-2">Remember the host connect name, next to Scoreboard (<b>8a5xwesa</b>).</p>
        <p className="mt-2">Click "<b>Join game</b>" to be the first player.</p>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        ...
        <p className="mt-2">Click "<b>Start</b>" to play in single mode.</p>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        ...
        <p className="mt-2">Click on the map to place a bomb, try to be near stars to blow them up.</p>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        ...
        <p className="mt-2">On other device, at step 1 click "<b>Join a game</b>".</p>
        <p className="mt-2">Enter first device (host)'s connect name.</p>
        <p className="mt-2">Click "<b>Connect</b>".</p>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        <h2 className="text-xl font-semibold">Multi-players</h2>
        <p className="mt-2">Confirm the "Connected to..." notification on both devices.</p>
        <p className="mt-2">Confirm the first player on the dashboard.</p>
        <p className="mt-2">Click "<b>Join game</b>" to be the second player.</p>
      </div>
    ),
  ...
  },
  {
    content: (
      <div>
        ...
        <p className="mt-2">Click "<b>Start/Next</b>" button to start the game.</p>
      </div>
    ),
