...
export const MenuModal: React.FC<Props> = ({ onClose, onConnect, onStartServer, onInfoClick }) => {
  ...
  return (
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 w-full max-w-md max-h-full">
      <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
        {onInfoClick && <button
          type="button"
          className='absolute top-1 bg-white rounded-full p-2'
          onClick={onInfoClick}
        >
        ...
        <button
          type="button"
          className="absolute top-1 end-1 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center z-10"
